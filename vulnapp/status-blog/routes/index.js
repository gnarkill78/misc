...
//            res.render('index', { users: users, username: req.session.username});
            res.status(302).render('index', { users: users, username: req.session.username, title: 'WELCOME'});
          } else {
//            res.render('index', { users: users });
            res.status(200).render('index', { users: users, username: req.session.username, title: 'WELCOME'});
          }
      })
  })
});
